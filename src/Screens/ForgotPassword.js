...
return (
  ...
  <button onClick={handleSubmit}  type="submit" className="btn btn-primary">GET OTP</button>
            ...
            <div>
             ...
             <div className="form-group">
                 <label for="exampleInputEmail1">Email address</label>
                 <input disabled={true} type="email" name='email' value={values.email} onChange={handleInputs}  className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" />
                 <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
             </div>
             <div className="form-group">
                 <label for="exampleInputEmail1">OTP</label>
                 <input type="number" name='otp' value={values.otp} onChange={handleInputs}  className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" />
             </div>
             <div className="form-group">
                 <label for="exampleInputEmail1">New Password</label>
                 <input type="text" name='n_pass' value={values.n_pass} onChange={handleInputs}  className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" />
             </div>
         ...
         <>
            ...
            <h1 style={{textAlign:'center' ,marginTop:'15%' ,color:"red"}}>LOADING... || Please Wait For Some Time...</h1>
