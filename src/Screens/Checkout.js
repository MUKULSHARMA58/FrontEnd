...
<>
    ...
    <div class="form-group">
      ...
      <input type="text" name="house" value={new_address.house} onChange={hanldeInput} class="form-control" id="exampleFormControlInput1" placeholder="House No." />
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput1">Street.</label>
      <input type="text" name="street" value={new_address.street} onChange={hanldeInput} class="form-control" id="exampleFormControlInput1" placeholder="Street." />
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput1">Landmark</label>
      <input type="text" name="landmark" value={new_address.landmark} onChange={hanldeInput} class="form-control" id="exampleFormControlInput1" placeholder="Landmark" />
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput1">Pincode</label>
      <input type="text" name="pincode" value={new_address.pincode} onChange={hanldeInput} class="form-control" id="exampleFormControlInput1" placeholder="Pincode" />
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput1">Alternate Mobile.</label>
      <input type="number" name="alter_mobile" value={new_address.alter_mobile} onChange={hanldeInput} class="form-control" id="exampleFormControlInput1" placeholder="+91-XXXXXXXXXX" />
    </div>
...
<a  onClick={()=>{handleAddNewAddress()}} class="btn btn-primary" style={{width  :"100%" ,  borderRadius:10 ,  marginTop  :10}}>Add New Address</a>
    ...
    <>
    {getAddress.map((el,i)=>(
      <div class="card" style={{width: '18rem',  display:"flex" ,justifyContent  :"center" , alignItems : "center", margin:'auto'}}>
      <div class="card-body">
      <h5 class="card-title">Primary Address</h5>
      <p class="card-text">
        <h5>House No.{el.house}</h5>
        <h5>Street:{el.street}</h5>
        <h5>Landmark:{el.landmark}</h5>
        <h5>Pincode:{el.pincode}</h5>
      </p>
